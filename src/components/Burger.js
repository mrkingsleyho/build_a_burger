...
export default class Burger extends Component {
    ...
    burgerContent = () => {
        ...
        if(burger.length === 0)
            burger.push(<p key="0" style={{color: '#c17116'}}>Choose your toppings!</p>);
        return burger;
    }
    ...
    render(){
        return (
            <>
                <div className="burgerIngredients" style={{padding: '50px 0px 60px 0px'}}>
                    <div className="topSide" style={{paddingTop: '50px'}}></div>
                    {this.burgerContent()}
                    <div className="bottomSide" style={{padding: '50px 0px 50px 0px'}}></div>
                </div>
